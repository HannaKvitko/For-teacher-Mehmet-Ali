Feature:
  ...
  Scenario Outline: TC01 Adding a new citizenship successfully
    ...
    Examples:
      ...
      | Wqrst01 | w1qe01     | Citizenship successfully created |Citizenship successfully deleted
      | Wqrst02 | w1qe02     | Citizenship successfully created |Citizenship successfully deleted
      | Wqrst03 | w1qe03     | Citizenship successfully created |Citizenship successfully deleted
      | Wqrst05 | w1qe04     | Citizenship successfully created |Citizenship successfully deleted
      | Wqrst06 | w1qe05     | Citizenship successfully created |Citizenship successfully deleted
