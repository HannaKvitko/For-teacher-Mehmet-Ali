...
public class SetUpPage extends ParentPage {
        ...
        switch (nameOfWebelement) {
            ...
            public WebElement getWebElements (String nameOfWebelement){
                switch (nameOfWebelement) {
                    ...
                    case "priorityCodeAddingFees":
                        return this.priorityCodeAddingFees;
                    case "toggleBarAddingFees":
                        return this.toggleBarAddingFees;
                }
                return null;
                return null;
            }
    ...
    public WebElement getWebElements(String s) {
    }
